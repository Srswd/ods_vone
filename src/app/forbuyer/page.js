...
import Moneybanner from "../../../public/M11.jpg"
import styles from "@/app/forbuyer/page.module.css"
...
const Buyer = () => {
  return (
    ...
    <div className={styles.container}>
      ...
      <Image src={Moneybanner} alt="Moneybanner"className={styles.hero}/>
    </div>
      <div className={styles.item}>
    ...
    <h1 className={styles.register}>Register Now</h1>
    <form>
